...
class App {
  ...
  _showForm(mapE, buttonShow = true) {
    this.#mapEvent = mapE;
  ...
  // workout element add event listener
  _edit(workoutId) {
    inputDistance.focus();
    // display the form
    ...
    workoutEl.addEventListener('click', this._edit.bind(this, workoutId));
    // hide the workout element
    workoutEl.style.display =
      // fill the form with the data of the workout
